...
function handle_content_syntax(): void {
    $groups = [
        [
            'label' => 'CMS Fields',
            'rows' => [
                ['syntax' => '<span data-outpost="field_name" />',                        'description' => 'Editable text field — HTML-escaped output'],
                ['syntax' => '<span data-outpost="field_name">Default</span>',            'description' => 'Text field with default shown until client saves a value'],
                ['syntax' => '<div data-outpost="field_name" data-type="richtext" />',    'description' => 'Rich text (HTML) field — output as-is, no escaping'],
                ['syntax' => '<img data-outpost="field_name" data-type="image" />',       'description' => 'Image URL field — outputs the upload path'],
                ['syntax' => '<span data-outpost="field_name" data-type="textarea" />',   'description' => 'Multi-line text — preserves line breaks'],
                ['syntax' => '<a data-outpost="field_name" data-type="link" />',           'description' => 'URL / link field'],
                ['syntax' => '<span data-outpost="field_name" data-type="color" />',      'description' => 'Hex color value (e.g. #14B8A6)'],
                ['syntax' => '<span data-outpost="field_name" data-type="number" />',     'description' => 'Numeric field'],
                ['syntax' => '<span data-outpost="field_name" data-type="date" />',       'description' => 'Date field'],
                ['syntax' => '<span data-outpost="field_name" data-type="select" />',     'description' => 'Select field — outputs the chosen value'],
                ['syntax' => '<span data-outpost="field_name" data-type="toggle" />',     'description' => 'Boolean toggle — use <outpost-if field="name" exists> for logic'],
            ],
        ],
        [
            'label' => 'Collection Loops',
            'rows' => [
                ['syntax' => '<outpost-each collection="slug">',                          'description' => 'Loop over all published items in a collection'],
                ['syntax' => '<outpost-each collection="slug" limit="5">',                'description' => 'Loop with a result limit'],
                ['syntax' => '<outpost-each collection="slug" orderby="field">',          'description' => 'Sort by a field (descending)'],
                ['syntax' => '<outpost-each collection="slug" paginate="10">',            'description' => 'Paginate — show N per page; add <outpost-pagination /> after loop'],
                ['syntax' => '<outpost-each collection="slug" filteredby="param">',       'description' => 'Filter by URL query param matching folder label slugs'],
                ['syntax' => '<outpost-each collection="slug" related="var">',            'description' => 'Show items sharing folder labels with the named variable'],
                ['syntax' => '</outpost-each>',                                            'description' => 'Close the loop'],
                ['syntax' => '<outpost-pagination />',                                     'description' => 'Render page navigation after a paginate: loop'],
                ['syntax' => '<span data-outpost="field_name" />',                        'description' => 'Output a field from the current loop item (HTML-escaped)'],
                ['syntax' => '<div data-outpost="field_name" data-type="richtext" />',    'description' => 'Output a richtext field from loop item (unescaped)'],
                ['syntax' => '<a data-outpost="url" />',                                   'description' => 'Full URL path to this item (e.g. /blog/my-post)'],
                ['syntax' => '<span data-outpost="slug" />',                               'description' => 'URL-safe identifier for the item'],
                ['syntax' => '<span data-outpost="published_at" />',                       'description' => 'Publish date/time string'],
            ],
        ],
        [
            'label' => 'Single Item',
            'rows' => [
                ['syntax' => '<outpost-single collection="slug">', 'description' => 'Fetch a single item — slug read from ?slug= query param'],
                ['syntax' => '</outpost-single>',                  'description' => 'Close the single block'],
            ],
        ],
        [
            'label' => 'Folder Loops',
            'rows' => [
                ['syntax' => '<outpost-each folder="slug">',       'description' => 'Iterate over all labels in a folder'],
                ['syntax' => '<span data-outpost="name" />',       'description' => 'Display name of the label'],
                ['syntax' => '<span data-outpost="slug" />',       'description' => 'URL-safe slug of the label'],
                ['syntax' => '<span data-outpost="count" />',      'description' => 'Number of items tagged with this label'],
                ['syntax' => '</outpost-each>',                     'description' => 'Close the folder loop'],
            ],
        ],
        [
            'label' => 'Menu Loops',
            'rows' => [
                ['syntax' => '<outpost-menu name="slug">',                    'description' => 'Iterate over items in a navigation menu'],
                ['syntax' => '<span data-outpost="label" />',                 'description' => 'Menu item display text'],
                ['syntax' => '<a data-outpost="url" />',                      'description' => 'Menu item URL'],
                ['syntax' => '<span data-outpost="target" />',                'description' => 'Link target (_blank for new tab, empty otherwise)'],
                ['syntax' => '</outpost-menu>',                                'description' => 'Close the menu loop'],
            ],
        ],
        [
            'label' => 'Gallery & Repeater',
            'rows' => [
                ['syntax' => '<outpost-each gallery="field_name">',           'description' => 'Iterate over images in a gallery field'],
                ['syntax' => '<img data-outpost="url" data-type="image" />', 'description' => 'Image URL within the gallery'],
                ['syntax' => '<outpost-each repeater="field_name">',          'description' => 'Iterate over rows in a repeater field'],
                ['syntax' => '<span data-outpost="sub_field" />',             'description' => 'Access a sub-field within the repeater row'],
                ['syntax' => '</outpost-each>',                                'description' => 'Close the gallery or repeater loop'],
            ],
        ],
        [
            'label' => 'Conditionals',
            'rows' => [
                ['syntax' => '<outpost-if field="name" exists>',              'description' => 'True when any field has a non-empty value (text, toggle, repeater, etc.)'],
                ['syntax' => '<outpost-if field="name" value="x">',           'description' => 'String equality check on a field'],
                ['syntax' => '<outpost-if field="name" not-value="x">',       'description' => 'String inequality check'],
                ['syntax' => '<outpost-if field="name" scope="global" exists>','description' => 'True when a global field has a value'],
                ['syntax' => '<outpost-if admin>',                             'description' => 'True only when a logged-in admin is previewing the page'],
                ['syntax' => '</outpost-if>',                                  'description' => 'Close the conditional'],
            ],
        ],
        [
            'label' => 'Globals & Meta',
            'rows' => [
                ['syntax' => '<span data-outpost="name" data-scope="global" />',                       'description' => 'Site-wide global field (shared across all pages)'],
                ['syntax' => '<div data-outpost="name" data-scope="global" data-type="richtext" />',   'description' => 'Global rich text field — output as-is'],
                ['syntax' => '<img data-outpost="name" data-scope="global" data-type="image" />',      'description' => 'Global image field'],
                ['syntax' => '<a data-outpost="name" data-scope="global" data-type="link" />',         'description' => 'Global URL/link field'],
                ['syntax' => '<outpost-meta title="Default" />',      'description' => 'Page meta title — falls back to default if not set in admin'],
                ['syntax' => '<outpost-meta description="Default" />', 'description' => 'Page meta description with fallback'],
            ],
        ],
        [
            'label' => 'Includes & Comments',
            'rows' => [
                ['syntax' => '<outpost-include partial="name" />',  'description' => "Include a partial from the theme's partials/ directory (no extension)"],
                ['syntax' => '<!-- comment text -->',               'description' => 'HTML comment — standard HTML comments in templates'],
            ],
        ],
    ];
