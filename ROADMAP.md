...
- **Visual form builder** — 14 field types, drag-and-drop, `{% form 'slug' %}` template tag, enhanced submissions inbox, Forge auto-create from HTML (v2.7.0), CSS class preservation (v2.7.2), per-form notification email (v2.7.3)
